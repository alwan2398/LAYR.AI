...
interface ResizablePanelGroupProps extends React.ComponentProps<
  typeof PanelGroup
> {
  className?: string;
}
...
interface ResizableHandleProps extends React.ComponentProps<
...
type ImperativePanelHandle = React.ElementRef<typeof Panel>;
